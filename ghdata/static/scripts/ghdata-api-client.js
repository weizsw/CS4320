...
GHDataAPIClient.prototype.issues_reopened = function (params) {
  return this.get('timeseries/issues_reopened', params);
};

GHDataAPIClient.prototype.release_velocity = function (params) {
  return this.get('timeseries/release_velocity', params);
};

GHDataAPIClient.prototype.issues_comments = function (params) {
  return this.get('timeseries/issues_comments', params);
};

GHDataAPIClient.prototype.contribution_acceptance = function (params) {
  return this.get('pulls/acceptance_rate', params);
};

GHDataAPIClient.prototype.time_to_contributor = function (params) {
  return this.get('timeseries/time_to_contributor', params);
};
