...
app.route('/{}/<owner>/<repo>/timeseries/issues_reopened'.format(GHDATA_API_VERSION))(flaskify_ghtorrent(app, ghtorrent.issues_reopened))

app.route('/{}/<owner>/<repo>/timeseries/release_velocity'.format(GHDATA_API_VERSION))(flaskify_ghtorrent(app, ghtorrent.release_velocity))

app.route('/{}/<owner>/<repo>/timeseries/issues_comments'.format(GHDATA_API_VERSION))(flaskify_ghtorrent(app, ghtorrent.issues_comments))

app.route('/{}/<owner>/<repo>/pulls/acceptance_rate'.format(GHDATA_API_VERSION))(flaskify_ghtorrent(app, ghtorrent.contribution_acceptance))

app.route('/{}/<owner>/<repo>/timeseries/time_to_contributor'.format(GHDATA_API_VERSION))(flaskify_ghtorrent(app, ghtorrent.time_to_contributor))
